package org.trainingsession.project.resources
...
val Restore: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Restore",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
private fun RestorePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Restore, contentDescription = null)
    }
}
